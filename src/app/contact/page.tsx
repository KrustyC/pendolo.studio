...
const brandCircle = "/brand.svg";
const webDesignCircle = "/web-design.svg";
const webDevCircle = "/web-dev.svg";
...
export default function ContactPage() {
  ...
  const chipTextClass =
    "relative z-10 font-light tracking-tight leading-[1.05] transition-[font-weight] duration-150";
  const chipCircleClass =
    "pointer-events-none absolute -inset-x-2 -inset-y-1 h-[calc(100%+0.5rem)] w-[calc(100%+1rem)] max-w-none";
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setFormData({ name: "", email: "", company: "", service: [], budget: "" });
  };
      ...
      <div className="container mx-auto w-full px-3 md:px-4 lg:px-6">
        <div className="max-w-5xl mx-auto animate-fade-up">
          <form onSubmit={handleSubmit} className="mx-auto w-fit max-w-full space-y-4">
                  ...
                  {[
                    ...
                    >
                      {formData.service.includes(service.value) ? (
                        <img src={service.circle} alt="" aria-hidden="true" className={chipCircleClass} />
                      ) : null}
                      <span className="relative z-10 grid">
                        <span
                          aria-hidden="true"
                          className="invisible col-start-1 row-start-1 font-semibold tracking-tight leading-[1.05]"
                        >
                          {service.label}
                        </span>
                        <span
            ...
            <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1 text-2xl md:text-3xl font-light tracking-tight leading-[1.05] text-white">
              <span className="inline-block w-[13.5rem] md:w-[16rem] text-right whitespace-nowrap">
