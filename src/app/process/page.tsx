...
const processSteps = [
  {
    ...
    title: "Discovery",
    description:
      "We start by listening. Understanding your business, your audience, your goals, and the constraints we're working within.",
    details: [
  ...
  },
  {
    ...
    description:
      "Before any visual work begins, we map the landscape. Competitor analysis, content audit, and information architecture define the foundation.",
    details: [
  ...
  },
  {
    ...
    title: "Design",
    description:
      "Visual direction, interface design, and brand systems. Every design decision is grounded in the research phase. Iteration is structured, not endless.",
    details: [
  ...
  },
  {
    ...
    title: "Development",
    description:
      "Clean code, modern frameworks, performance-first architecture. Development runs parallel to final design refinements, not after them.",
    details: [
  ...
  },
  {
    ...
    description:
      "Performance testing, accessibility audits, cross-browser checks. We test under real-world conditions, not just ideal ones.",
    details: [
  ...
  },
  {
    ...
    description:
      "Deployment with confidence. Monitoring, observability, and analytics from day one. We don't launch and disappear.",
    details: [
      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="max-w-4xl mb-28 animate-fade-up">
          ...
          <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl">
            Every project follows a clear process. It adapts to the scope and complexity of the work,
                ...
                <div className="md:col-span-7 md:pl-8">
                  <ul className="space-y-4">
                    {step.details.map((detail) => (
                      <li
                        key={detail}
                        className="text-sm text-muted-foreground flex items-start gap-4"
                      >
        ...
        <div className="border-t border-border pt-20 mt-8">
          ...
          <Link href="/contact" className="cta-marketing">
            Start a project
